  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: 'daa9e8c8-c11c-4717-bd85-c4e4c6c82607', // Replace with your Web3Forms access key
          name: formData.name,
          ...
          <div className='bg-gray-50 dark:bg-gray-700 p-8 rounded-xl'>
            ...
            <div className='space-y-6'>
              ...
              <button
                ...
                className='w-full px-6 py-4 bg-primary text-accent font-semibold rounded-lg hover:opacity-95 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed'
              >
