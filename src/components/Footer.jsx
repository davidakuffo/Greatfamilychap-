...
const Footer = () => {
  ...
  const contactDetails = [
    { 
      ...
      text: '123 Faith Street, Accra, Ghana'
    },
    { 
      icon: (
        <svg className='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
    ...
    { 
      ...
      text: 'info@greatfamilychapel.org'
    }
  ]

  return (
    <footer className='bg-detail text-accent transition-colors duration-300'>
      {/* Main Footer Content */}
  ...
  <a href='#' className='w-10 h-10 bg-primary hover:bg-secondary rounded-full flex items-center justify-center text-accent hover:text-detail transition-all duration-300'>
